...
export function Hero() {
  ...
  const [_, setIsVideoLoaded] = useState(false)
  ...
  return (
    <div className="relative min-h-screen pt-20 px-4 md:px-8">
      ...
      <div className="relative h-[calc(100vh-6rem)] rounded-lg overflow-hidden">
        ...
        {/* Navigation Dots (only visible on smaller screens) */}
        <div className="lg:hidden absolute bottom-8 left-1/2 transform -translate-x-1/2 flex space-x-2 z-20">
