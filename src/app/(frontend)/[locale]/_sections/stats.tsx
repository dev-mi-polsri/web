      ...
      <div className="relative z-10 container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-white">
          ...
          <div className="space-y-2">
            ...
            <div className="text-sm md:text-base font-medium">Mahasiswa DIII</div>
          </div>

          {/* DIV Students */}
          <div className="space-y-2">
            <div className="text-4xl md:text-6xl font-bold">390+</div>
            <div className="text-sm md:text-base font-medium">Mahasiswa DIV</div>
          </div>

          {/* Lecturers */}
          <div className="space-y-2">
            <div className="text-4xl md:text-6xl font-bold">84+</div>
            <div className="text-sm md:text-base font-medium">Dosen</div>
          </div>

          {/* Staff */}
          <div className="space-y-2">
            <div className="text-4xl md:text-6xl font-bold">13+</div>
            <div className="text-sm md:text-base font-medium">Tendik</div>
          </div>
        </div>
      </div>
    </section>
