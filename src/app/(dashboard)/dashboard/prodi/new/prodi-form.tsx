...
type ProdiFormProps = {
  initialValues?: Partial<Value<ProdiFormValues>>
  onSubmit: (values: Value<ProdiFormValues>) => void
  isLoading?: boolean
  children?: ReactNode
  skipValidation?: Record<keyof Pick<ProdiFormValues, 'thumbnail'>, boolean>
  title?: string
...
export function ProdiForm({
  ...
  const prodiScopeOptions = Object.values(PostScope)
          ...
          <Field data-disabled={isLoading} data-invalid={!!form.values.scope.error}>
            ...
            <FieldContent>
              ...
              >
                ...
                <SelectContent>
                  {prodiScopeOptions.map((value) => (
                    <SelectItem key={value} value={value}>
                      {PRODI_SCOPE_LABEL[value] ?? value}
                    </SelectItem>
                  ))}
                </SelectContent>
              </Select>
