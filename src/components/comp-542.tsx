...
const SAMPLE_EVENTS: CalendarEvent[] = [
  ...
  },
  {
    ...
    end: setMinutes(setHours(addDays(new Date(), 5), 14), 45), // 2:45 PM,  4),  14),  30),  // 2:30 PM,  4 days from now
    color: 'rose',
    location: 'Downtown Cafe',
  },
  {
...
export default function Component() {
  const [events, _] = useState<CalendarEvent[]>(SAMPLE_EVENTS)

  return <EventCalendar className="w-full" events={events} readOnly />
}
